...
4. КРИТИЧЕСКИЙ ПРИМЕР:
   "Привет [имя], короче машин нет, я не знаю что делать"
   ПРАВИЛЬНО: Говорящий сообщает [имени], что у говорящего нет машин
   НЕПРАВИЛЬНО: [имя] ищет машину
   
5. ТИПИЧНЫЕ ОШИБКИ:
   ❌ "[имя] ищет машину" - НЕВЕРНО, если [имя] упомянуто в начале
   ✅ "Говорящий сообщает [имени] о проблеме с машиной" - ВЕРНО
   ❌ "[имя] просит помощи" - НЕВЕРНО, если сообщение начинается "[имя], помоги"
   ✅ "Говорящий просит помощи у [имени]" - ВЕРНО

ЗАПОМНИ: Имя в начале = тот, КОМУ говорят, а не тот, КТО говорит!
</critical_context_rule>
