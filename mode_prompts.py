...
# Universal rule to prepend to all prompts
UNIVERSAL_RULE = """
<universal_style_rule>
ВАЖНО: Никогда не используй слова "Говорящий", "спикер", "автор сообщения" и т.п.
Пиши безлично или от третьего лица, используя местоимения или контекст.

Примеры:
❌ НЕПРАВИЛЬНО: "Говорящий просит перенести встречу"
✅ ПРАВИЛЬНО: "Просит перенести встречу" или "Просьба перенести встречу"

❌ НЕПРАВИЛЬНО: "Спикер сообщает о проблеме"
✅ ПРАВИЛЬНО: "Сообщается о проблеме" или "Информирует о проблеме"

❌ НЕПРАВИЛЬНО: "Автор голосового спрашивает"
✅ ПРАВИЛЬНО: "Спрашивает" или "Вопрос о..."

Используй:
- Безличные конструкции: "Сообщается", "Просят", "Предлагается"
- Глаголы в 3-м лице без подлежащего: "Просит", "Спрашивает", "Предлагает"
- Контекст и имена, когда они известны: "[Имя] просит", "Начальник требует"
</universal_style_rule>
"""
